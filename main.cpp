...
// #include<conio.h> // Removed: not available on macOS/Linux
#include <string>
using namespace std;
...
int main()
{
    ...
    while (1)
    {
        ...
        system("clear"); // Clear screen (Linux/macOS only)
        cout << "             =================              " << endl;
        cout << "             |   Bank Menu   |              " << endl;
        cout << "==========================================" << endl;
        ...
        // #include <conio.h> // Pause screen (Windows only, place at top of file)
        // getch(); // Pause screen (Windows only)
        cout << "\nPress Enter to continue..."; // Pause screen (Linux/macOS only)
        cin.ignore();                           // Pause screen (Linux/macOS only)
        cin.get();                              // Pause screen (Linux/macOS only)
    }
